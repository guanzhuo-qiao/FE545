...
int main()
{
    ...
    cout << "euro price using binomial tree: " << euroPrice << " amer price using binomial tree: " << americanPrice << "\n";

	SimpleTrinomialTree theTreeTri(Spot, rParam, dParam, Vol, Steps, Expiry);
	double americanTriPrice = theTreeTri.GetThePrice(americanOption);
	double euroTriPrice = theTreeTri.GetThePrice(europeanOption);
	cout << "euro price using trinomial tree: " << euroTriPrice << " amer price using trinomial tree: " << americanTriPrice << "\n";
 ...
 //   SimpleBinomialTree theNewTree(Spot,rParam,dParam,Vol,Steps,Expiry);
	//SimpleTrinomialTree theNewTreeTri(Spot, rParam, dParam, Vol, Steps, Expiry);

 //   double euroNewPrice = theNewTree.GetThePrice(europeanOption);
 //   double americanNewPrice = theNewTree.GetThePrice(americanOption);
	//double americanNewTriPrice = theNewTreeTri.GetThePrice(americanOption);

 //   cout << "euro new price " << euroNewPrice << " amer new price " << americanNewPrice << "\n";
	//cout << " amer new price using trinomial tree" << americanNewTriPrice << "\n";
